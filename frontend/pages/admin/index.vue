  ...
  <v-row v-if="currentUser">
    ...
    <v-col cols="12" sm="7">
      ...
      <v-tabs v-model="tab" align-with-title color="#284177">
        <v-tab> Lista Usuários </v-tab>
        <v-tab> Cadastro de Usuários</v-tab>
      </v-tabs>
      ...
      <v-tabs-items v-model="tab">
        <v-tab-item>
          <v-card flat>
            <v-card-text><CompTabelaUsuario /></v-card-text>
          </v-card>
        </v-tab-item>
        <v-tab-item>
          <v-card flat>
            <v-card-text><CompCadastrarUsuario /></v-card-text>
          </v-card>
        </v-tab-item>
      </v-tabs-items>
...
import CompTabelaUsuario from "../../components/Admin/CompTabelaUsuario.vue";
import CompCadastrarUsuario from "../../components/Admin/CompCadastrarUsuario.vue";
